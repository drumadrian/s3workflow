...
def detect_pii_entities(comprehend_client, DetectedText_list):
    response = comprehend_client.detect_pii_entities(
    Text=DetectedText_list,
    LanguageCode='en'
...
if __name__ == '__main__':
    ...
    try:
        ...
        sdk.add_custom_request_attribute('Container', 'comprehendcontainer')

        while True:
            with sdk.trace_custom_service('get_message()', 'SQS'):
                message = get_message(sqs_client, COMPREHEND_QUEUE)

            DetectedText_list = ""
            for TextDetection in message['detect_text_response']['TextDetections']:
